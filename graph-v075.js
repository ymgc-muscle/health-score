...
function g75LoadNotifications(){
  ...
  g75NotifyLoadPromise=(async()=>{
    ...
    await g75LoadScript('notifications-v079.js?v=085','notify-v079');
    await g75LoadScript('notification-route-v081.js?v=081','notification-route-v081');
