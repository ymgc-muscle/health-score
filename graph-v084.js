...
function g84EmphasizeTrend(){
  ...
  if(help&&help.innerHTML&&!help.innerHTML.includes('緑の太線＝7日移動平均')){
    help.innerHTML=`<b>緑の太線＝7日移動平均（トレンド）</b>。青の破線＝14日移動平均のトレンドからの達成見込み、橙の細線・点＝日々の実測値、灰色の破線＝目標ライン。<br>${help.innerHTML}`;
  }
}
